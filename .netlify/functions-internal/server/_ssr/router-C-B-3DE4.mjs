...
import { A as LogOut, B as Film, E as MessageSquare, G as Crown, S as Plus, i as UserRound, lt as ArrowRight, m as Shield, n as X, ot as Bell, p as Sparkles, u as Trash2, v as Scale } from "../_libs/lucide-react.mjs";
...
import { t as Route$11 } from "./edit-listing._id-DCh0NGHw.mjs";
import { i as DialogTitle, n as DialogContent, r as DialogHeader, t as Dialog } from "./dialog-Cu5CqtGL.mjs";
import { t as PremiumPaywallModal } from "./PremiumPaywallModal-CI3HzgS0.mjs";
import { n as useCompare, t as compareStore } from "./compare-DGn_cp8p.mjs";
import { t as Route$12 } from "./my-listings-C9z2pH40.mjs";
import { t as Route$13 } from "./vehicle._id-idi9RmsI.mjs";
import { t as Route$14 } from "./seller._id-CMPGNaPt.mjs";
import { i as Trigger, n as Portal, r as Root2, t as Content2 } from "../_libs/radix-ui__react-popover.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-C-B-3DE4.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Cq3wenmg.css";
		...
		children: [
						...
						children: [
							...
							user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: profile?.first_name ?? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserRound, { className: "h-4 w-4 inline" })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									variant: "ghost",
									size: "icon",
			...
			!isAuthPage && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
				...
				children: [
					...
					" · Strictly vehicles only · Made in Algeria"
				]
			}),
...
var $$splitComponentImporter$9 = () => import("./reels-C-Jd1Dcg.mjs");
var Route$9 = createFileRoute("/reels")({
	head: () => ({ meta: [{ title: "Reels · GRAND Auto Luxe" }] }),
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("./post-reel-ISPsTt4t.mjs");
var Route$8 = createFileRoute("/post-reel")({
	head: () => ({ meta: [{ title: "نشر ريلز · GRAND Auto Luxe" }] }),
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("./post-B6IUrxUa.mjs");
var Route$7 = createFileRoute("/post")({
	head: () => ({ meta: [{ title: "List your vehicle · GRAND Auto Luxe" }] }),
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("./plans-CCmXYTpY.mjs");
var Route$6 = createFileRoute("/plans")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./messages-CIFMIYCf.mjs");
var Route$5 = createFileRoute("/messages")({
	head: () => ({ meta: [{ title: "Messages · GRAND Auto Luxe" }] }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./checkout-n4IN6EhR.mjs");
...
var ReelsRoute = Route$9.update({
	id: "/reels",
	path: "/reels",
	getParentRoute: () => Route$10
});
var PostReelRoute = Route$8.update({
	id: "/post-reel",
	path: "/post-reel",
	getParentRoute: () => Route$10
});
var PostRoute = Route$7.update({
	id: "/post",
	path: "/post",
	getParentRoute: () => Route$10
});
var PlansRoute = Route$6.update({
	id: "/plans",
	path: "/plans",
	getParentRoute: () => Route$10
});
var MyListingsRoute = Route$12.update({
	id: "/my-listings",
	path: "/my-listings",
	getParentRoute: () => Route$10
});
...
var VehicleIdRoute = Route$13.update({
	id: "/vehicle/$id",
	path: "/vehicle/$id",
	getParentRoute: () => Route$10
});
var SellerIdRoute = Route$14.update({
	id: "/seller/$id",
	path: "/seller/$id",
	getParentRoute: () => Route$10
});
var rootRouteChildren = {
	...
	PostReelRoute,
	ReelsRoute,
	EditListingIdRoute: Route$11.update({
		id: "/edit-listing/$id",
